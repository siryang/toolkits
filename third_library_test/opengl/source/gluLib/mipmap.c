/* 
** We removed the gluBuild2DMipmaps() related functions from this file.
** Mapbar Inc.
*/
...
#if defined(MAPBAR_USE_OPENGL) || defined(MAPBAR_USE_DIRECT3D)
...
#endif  //!defined(MAPBAR_ANDROID) && !defined(MAPBAR_IPHONE)
#endif //#if defined(MAPBAR_USE_OPENGL) || defined(MAPBAR_USE_DIRECT3D)
