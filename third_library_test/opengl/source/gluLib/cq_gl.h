/** 
	This file is almost same with default <gl/gl.h> in Windows. It is created to let some glu-functions can be used without using the 
	OpenGL headers and libraries of Windows.
*/
#ifndef _CQ_GL_H
#define _CQ_GL_H

#if !defined(MAPBAR_USE_OPENGL)  
...
///////////////////////////////////////////////////////////////////
// Elements from later versions of OpenGL.
///////////////////////////////////////////////////////////////////
...
/** 
 Macros required by the mip-map part of the SGI GLU library.
 */
...
#endif  //#if !defined(MAPBAR_USE_OPENGL)
